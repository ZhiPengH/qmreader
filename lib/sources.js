...
const REFRESH_POLICIES = {
  ...
  xbangdan: { refreshIntervalMs: 2 * HOUR_MS, refreshPriority: 2, refreshCost: 1 },
...
const SOURCES = [
  ...
  { id: 'xbangdan', name: 'X榜单 · 长文榜', category: 'news', siteUrl: 'https://xbangdan.com/articles/', enabled: true, limit: 30,
    feeds: ['xbangdan:https://xbangdan.com/articles/'], description: 'X 长文收藏排行，仅收最近 21 天上榜' },
